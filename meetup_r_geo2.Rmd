...
# Sys.setlocale("LC_ALL","English") #onda ima problema s našim znakovima i slovima
#  sessionInfo()
#  Sys.getenv()
#Sys.setenv(LANG="Croatian_Croatia.1250")
#Sys.setenv(LC_NUMERIC="Croatian_Croatia.1250")
#Sys.getenv("LANG")
#Sys.setlocale(category = "LC_NUMERIC", locale = "")
old <- Sys.localeconv()
options(OutDec= ",")
#Sys.setlocale(category = "LC_ALL", locale = "")
#brojevi na lokalnom setingu
#instaliran webshot::install_phantomjs()
#prije toga instaliran paket webshot za interaktivne karte leaflet js
#webshot::install_phantomjs()
#system path variable C:\Users\Srce\AppData\Roaming\PhantomJS
#pregazi automatsko pronalaženje instalacije jave i dajemo path na low level R javu
...
img <- readPNG("D:\\SRCE_razno\\meetup\\Rlogo.png")
grid.raster(img)
```
